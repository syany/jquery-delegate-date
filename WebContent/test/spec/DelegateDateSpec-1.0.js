...
(function() {
  describe('$.Date', function() {
    ...
    describe('#01 Instance Test', function() {
      ...
      it('[T] execute as Function Date String.', function() {
      ...
      it('[+] Basic new with param.', function() {
    ...
    describe('#02 isLeapYear Test', function() {
      ...
      it('[+] 2100 for the instance.', function() {
